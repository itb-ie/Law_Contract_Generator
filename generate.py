...
def generate_excel():
    ...
    for i in range(len(lawyer)):
        ...
        para = doc.add_paragraph()
        para.alignment = WD_ALIGN_PARAGRAPH.LEFT
        run = para.add_run(parties.format(lawyer[i], client[i]))
        run.font.name = "Times New Roman"
        run.font.size = Pt(12)
        ...
        para = doc.add_paragraph()
        para.alignment = WD_ALIGN_PARAGRAPH.LEFT
        run = para.add_run(services.format(service[i]))
        run.font.name = "Times New Roman"
        run.font.size = Pt(12)
        ...
        para = doc.add_paragraph()
        para.alignment = WD_ALIGN_PARAGRAPH.LEFT
        run = para.add_run(compensation.format(compensation_value[i]))
        run.font.name = "Times New Roman"
        run.font.size = Pt(12)
        ...
        para.alignment = WD_ALIGN_PARAGRAPH.LEFT
        run = para.add_run(
            deposit.format(deposit_value[i], deposit_date[i], refundable_deposit_value[i], nonrefundable_deposit_value[i]))
        run.font.name = "Times New Roman"
        run.font.size = Pt(12)
        ...
        para = doc.add_paragraph()
        para.alignment = WD_ALIGN_PARAGRAPH.LEFT
        run = para.add_run(provisions.format(jurisdiction[i]))
        run.font.name = "Times New Roman"
        run.font.size = Pt(12)
    ...
    lb_status.config(text="Generated {} files".format(len(lawyer)))
